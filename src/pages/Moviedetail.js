...
const Moviedetails = () => {
  ...
  return (
    <div className='h-screen'>
      <div className='flex flex-col xl:flex-row md:flex-row lg:flex-row sm:flex-col justify-start bg-gray-800 h-[130%] xl:h-1/2 lg:h-1/2 md:h-[55%]  w-full max-w-[1550px] mx-auto min-h-[400px]'>
        <div>
